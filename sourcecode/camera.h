...
public:
	...
	void SetPaddingOffsetY(djfloat fOffsetY, djfloat fFactor = 1.0f)	
	{ 
		m_fPaddingDesiredOffsetY = fOffsetY; 
		m_fPaddingSpeedXFactor = fFactor;
	}
	djfloat GetPaddingOffsetY()							
	{ 
		return m_fPaddingOffsetY;
	}
};
